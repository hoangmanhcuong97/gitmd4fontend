...
function showUserDetail() {
    ...
    $('#posts').show();
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/showuserdetail/' + idAcc,
        method: 'GET',
        headers: {
...
function deletePost(idPost) {
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/deletepost/' + idPost,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function showListAddFriend() {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/showrequestfriend/' + idAcc,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function refuseFriend(idFriend) {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/refuse/' + idAcc + '/' + idFriend,
        method: 'DELETE',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function confirmFriend(idFriend) {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/confirmfriend/' + idAcc + '/' + idFriend,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function showListFriend() {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/showfriend/' + idAcc,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function showFriendDetail(idFriend) {
    $('#posts').hide();
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/showpostfriend/' + idFriend,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function searchFriend() {
    ...
    $.ajax({
        ...
        type: "POST",
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/searchfriend',
        success: function (data) {
            console.log(data)
            let result = ""
...
function addFriend(idFriend) {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/sendaddfriend/' + idAcc + '/' + idFriend,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function getListPost() {
    ...
    $.ajax({
        ...
        data: page,
        type: "POST",
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/timeline',
        success: function (data) {
            showPost(data);
        }
    })
...
function deleteComment(idComment, idPost) {
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/deletecomment/' + idComment,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function createLike(idPost) {
    let idAcc = window.sessionStorage.getItem('ID_KEY');
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/likeshow/' + idAcc + '/' + idPost,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function showRePost(idPost) {
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/findPost/' + idPost,
        method: 'GET',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function createCm(idPost) {
    ...
    $.ajax({
        url: 'https://app-hoang-manh-cuong.herokuapp.com/user/comment/' + idAcc + '/' + idPost,
        method: 'POST',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function post() {
    ...
    $.ajax({
        ...
        //tên API
        url: "https://app-hoang-manh-cuong.herokuapp.com/user/createPost",
